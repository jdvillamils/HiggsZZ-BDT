...
int ZZ(void){
    ...
    zchain->SetBranchAddress("lep_pt", &Lep_ptb);//, &b_Lep_ptb);
    zchain->SetBranchAddress("trigE", &TrigEb);//, &b_TrigEb);
    zchain->SetBranchAddress("trigM", &TrigMb);//, &b_TrigMb);
    zchain->SetBranchAddress("lep_n", &Lep_nb);//, &b_Lep_nb);
    zchain->SetBranchAddress("lep_phi", &Lep_phib);//, &b_Lep_phib);
    zchain->SetBranchAddress("lep_eta", &Lep_etab);//, &b_Lep_etab);
    zchain->SetBranchAddress("lep_E", &Lep_Eb);//, &b_Lep_Eb);
    zchain->SetBranchAddress("lep_ptcone30", &Lep_ptcone30b);//, &b_Lep_ptcone30b);
    zchain->SetBranchAddress("lep_etcone20", &Lep_etcone20b);//, &b_Lep_etcone20b);
    zchain->SetBranchAddress("lep_type", &Lep_typeb);//, &b_Lep_typeb);
    zchain->SetBranchAddress("lep_charge", &Lep_chargeb);//, &b_Lep_chargeb);
    zchain->SetBranchAddress("lep_trackd0pvunbiased", &lep_trackd0pvunbiasedb);//, &b_lep_trackd0pvunbiasedb);
    zchain->SetBranchAddress("lep_tracksigd0pvunbiased", &lep_tracksigd0pvunbiasedb);//, &b_lep_tracksigd0pvunbiasedb);
    zchain->SetBranchAddress("lep_z0", &Lep_z0b);//, &b_Lep_z0b);
    zchain->SetBranchAddress("jet_n", &jet_nb);//, &b_jet_nb);
    zchain->SetBranchAddress("jet_pt", &jet_ptb);//, &b_jet_ptb);
    zchain->SetBranchAddress("jet_eta", &jet_etab);//, &b_jet_etab);
